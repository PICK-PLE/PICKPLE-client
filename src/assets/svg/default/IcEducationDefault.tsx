...
const SvgIcEducationDefault = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 57 57" {...props}>
    <rect width={57} height={57} fill="#EEF" rx={10} />
    <g clipPath="url(#ic_education_default_svg__a)">
      <path
        fill="#6360FF"
        stroke="url(#ic_education_default_svg__b)"
        strokeWidth={1.173}
    ...
    <defs>
      <linearGradient
        id="ic_education_default_svg__b"
        x1={44.059}
        x2={10.748}
        y1={10.906}
        y2={41.62}
      ...
      <clipPath id="ic_education_default_svg__a">
        <path fill="#fff" d="M10.5 10.5h36v36h-36z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgIcEducationDefault;
