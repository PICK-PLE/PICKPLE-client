...
const SvgIcEducationInactive = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 57 57" {...props}>
    ...
    <g clipPath="url(#ic_education_inactive_svg__a)">
      <path
        fill="#C6CAD4"
        stroke="url(#ic_education_inactive_svg__b)"
        strokeWidth={1.173}
    ...
    <defs>
      <linearGradient
        id="ic_education_inactive_svg__b"
        x1={44.059}
        x2={10.748}
        y1={10.906}
        y2={41.62}
      ...
      <clipPath id="ic_education_inactive_svg__a">
        <path fill="#fff" d="M10.5 10.5h36v36h-36z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgIcEducationInactive;
