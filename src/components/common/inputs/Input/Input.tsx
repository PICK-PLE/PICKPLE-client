...
import React, { InputHTMLAttributes, useState, forwardRef, useImperativeHandle } from 'react';
import {
  inputContainerStyle,
  inputLabelStyle,
  inputWrapperStyle,
...
const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ value, onChange, isValid, inputLabel, placeholder, errorMessage, maxLength = 10, isCountValue = false }, ref) => {
    const [maxLengthError, setMaxLengthError] = useState(false);
    const [isFocused, setIsFocused] = useState(false);
